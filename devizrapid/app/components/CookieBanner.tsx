    ...
    <div className="fixed bottom-0 left-0 right-0 z-[10000] p-4">
      <div className="max-w-3xl mx-auto bg-white border border-gray-200 rounded-2xl shadow-lg px-5 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <p className="text-sm text-gray-600 leading-relaxed">
          Folosim cookie-uri strict necesare pentru autentificare și funcționarea aplicației. Nu urmărim activitatea și nu folosim cookie-uri de publicitate.{' '}
          <Link href="/confidentialitate" className="text-blue-600 hover:underline">Politica de confidențialitate</Link>
        </p>
        <button
          onClick={accept}
