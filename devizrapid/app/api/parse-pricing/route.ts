  ...
  const res = await fetch('https://api.groq.com/openai/v1/chat/completions', {
    ...
    body: JSON.stringify({
      ...
      messages: [
        {
          role: 'system',
          content: 'Esti asistent pentru comercianti romani. Primesti text dictat cu produse de pe factura unui furnizor. Extrage lista de produse. Raspunzi DOAR cu JSON, fara text, fara markdown. Format: {"items":[{"name":"denumire produs","unit":"buc","quantity":1,"supplier_price":0,"discount":0}]}. Discount e procentual (0 daca nu e mentionat). Unitate de masura: buc/kg/l/m/mp/ml/set/pereche etc. Pretul furnizorului e per unitate.',
        },
        {
          role: 'user',
          content: text,
