    ...
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <Section title="4. Politica de anulare abonament">
          <p>Puteti anula abonamentul oricand, fara penalitati, trimitand un email la <strong>leyla.omer@gmail.com</strong>.</p>
          <ul className="list-disc pl-5 mt-2 space-y-1">
        ...
        <Section title="5. Stergerea contului si a datelor">
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            ...
            <li><strong>Prin email:</strong> leyla.omer@gmail.com — procesam cererea in termen de 30 de zile (Art. 12(3) GDPR)</li>
          </ul>
